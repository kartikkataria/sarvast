  ...
  return (
    <div className="flex gap-3">
      ...
      <div className="flex-1 space-y-3 pt-0.5">
        ...
        {/* Generated image — shown after text */}
        {imageLoading && (
          <div className="flex items-center gap-2 rounded-xl border border-border bg-muted/40 px-4 py-3">
            <div className="h-4 w-4 animate-spin rounded-full border-2 border-primary border-t-transparent" />
            <span className="text-sm text-muted-foreground">Generating visual… this takes ~20 seconds</span>
          </div>
        )}
        {generatedImage && (
          <div className="overflow-hidden rounded-xl border border-border bg-white shadow-sm">
            ...
            <div className="flex items-center justify-between border-t border-border px-4 py-2.5">
              ...
              <a href={generatedImage} download="sarvast-visual.png" target="_blank" rel="noopener noreferrer"
